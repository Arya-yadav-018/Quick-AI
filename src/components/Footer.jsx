  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm/7 mt-6">
                Power your creativity with QuickAi.<br/> Revolutionize your creative process with our high-end AI tools. From professional writing to image generation, we help you work smarter and faster.
            </p>
        </div>
        ...
        <div>
            <h2 className="font-semibold text-gray-800 mb-5">Subscribe to our QuickAi</h2>
    ...
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
        <p className="text-center">
            Copyright 2025 © <a href="">QuickAi</a> All Right Reserved.
        </p>
